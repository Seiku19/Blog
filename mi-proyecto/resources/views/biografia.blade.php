...
<body data-spy="scroll" data-target=".navbar" data-offset="50" class="bg-primary">
    ...
    <div class="bg-primary row justify-content-center">
        <div class="bg-light col-8 mt-4 rounded">
            <h1>Jesus Cordoba</h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam, a expedita, distinctio quaerat cum neque
                dolor velit et, in pariatur architecto eveniet iusto. Ipsam veritatis, odit optio vitae doloribus
                consequuntur.</p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam, a expedita, distinctio quaerat cum neque
                dolor velit et, in pariatur architecto eveniet iusto. Ipsam veritatis, odit optio vitae doloribus
                consequuntur.</p>
